getgenv().jjdkekd30y9 = "幻脚本作者 神" --> 不要改, 改了会被踢
(function(define)
	repeat
    ...
    local check_whitelist = function()  --> 检查白名单功能        
        local url = "https://pastebin.com/raw/g9dYd5YH"; --> 白名单网址
	...
	local function checkModify()
		...
		--↓ 判断代码是否被修改
		if (getgenv().jjdkekd30y9 ~= "幻脚本作者 神" or not getgenv().jjdkekd30y9) and not isDev() then
			plr:Kick("请不要修改代码");
			task.wait(.01);
       -- while true do end
		end
	...
	Page1:NewButton("脚本作者  神#9999", function()
		print("感谢 紅")
	end)
	...
	Page1:NewButton("粉丝  平民#2723", function()
		print("感谢 cooper")
	end)
	
	Page1:NewButton("粉丝  穷人#3797", function()
		print("感谢 x**")
	end)
	
	Page1:NewButton("粉丝  乞丐#0001", function()
		print("感谢 wYn")
	end)
